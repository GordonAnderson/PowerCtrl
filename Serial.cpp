...
// PowerCtrl commands
  {"SSDLY",  CMDint, 1, (char *)&powerctrl.Sdelay},                       // Set start delay in mS
  {"GSDLY",  CMDint, 0, (char *)&powerctrl.Sdelay},                       // Returns start delay in mS
  {"SPTIME",  CMDint, 1, (char *)&powerctrl.Ptime},                       // Set push button time in mS
  {"GPTIME",  CMDint, 0, (char *)&powerctrl.Ptime},                       // Returns push button time mS
  {"R12V",  CMDfunction, 0, (char *)&Read12V},                            // Reads the 12 volt power supply
  {"R24V",  CMDfunction, 0, (char *)&Read24V},                            // Reads the 24 volt power supply
  {"OFF",  CMDfunction, 0, (char *)&TurnOff},                             // Powers down the controller
  {"ON",  CMDfunction, 0, (char *)&TurnOn},                               // Powers up the controller 
// End of table marker
  {0},
};
